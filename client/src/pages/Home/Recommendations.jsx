	...
	return (
		<div className='bg-white dark:bg-background py-10'>
			<div className='section flex gap-6 justify-between md:flex-row flex-col items-center'>
				...
				<div className='w-full md:w-1/2'>
					<div 
						className='w-full h-auto max-w-md mx-auto aspect-square rounded-lg bg-gradient-to-br from-primary/35 via-primary/25 to-primary/15 flex items-center justify-center shadow-lg'
						style={{
							backgroundImage: 'linear-gradient(135deg, hsl(200, 85%, 55%, 0.25) 0%, hsl(210, 80%, 50%, 0.2) 50%, hsl(220, 75%, 45%, 0.15) 100%)',
						}}
					>
						<div className='text-center p-8'>
							<div className='text-6xl mb-4'>🏠</div>
							<p className='text-muted-foreground font-medium'>Find Your Dream Home</p>
						</div>
					</div>
				</div>
			</div>
